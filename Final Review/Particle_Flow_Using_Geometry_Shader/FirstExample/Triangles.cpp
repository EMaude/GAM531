...
GLfloat vertices[NumParticles][3];
...
init(void)
{
	...
	{
		//Initial location for spawninig.
		//Here, I set all particles to be spawned from one point (0, 0, 0);
		float x = 0.0f;
		float y = 0.0f; 
		float z = 0.0f;
		vertices[i][0] = x;
		...
		//Random initial color for the particles
		...
		//Setting up other parameters for particles
...
main(int argc, char** argv)
{
	...
	glutCreateWindow("Particle Flow Using Age With Particles");
